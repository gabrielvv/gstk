  ...
  TestRunner(function() {
    ...
    describe('PersistedModel', function() {
      beforeEach(function() {
        ...
        ['Arbres', 'Parts', 'Tests', 'Feuilles', 'Qraps' /*, "Users"*/].forEach(
          function(sheetName) {
      ...
      it('PersistedModel_save DB_MODELS.COLUMNS', function() {
        ...
        var users = PersistedModel.findAll(
          { Index: obj.Index },
          new SheetDescriptor(TEST_SPREADHSEET_ID, 'Users'),
          DB_MODELS.COLUMNS
        );
      ...
      it('PersistedModel_save DB_MODELS.JSON (default behaviour)', function() {
        ...
        obj = JSON.parse(obj).instance;
        assert(obj.Index >= 0, 'obj.Index >= 0');
        var tests = PersistedModel.findAll(
          { Index: obj.Index },
          new SheetDescriptor(TEST_SPREADHSEET_ID, 'Tests'),
          DB_MODELS.JSON
        );
      ...
      it('PersistedModel.findByIndex DB_MODELS.JSON (default behaviour)', function() {
        ...
        /************/
        var t = PersistedModel.findByIndex(
          0,
          new SheetDescriptor(TEST_SPREADHSEET_ID, 'Tests'),
          DB_MODELS.JSON
        );
      ...
      it('PersistedModel.findByIndex DB_MODELS.COLUMNS', function() {
        ...
        o.save({ sheetName: 'Tests' });
        /************/
        var u = PersistedModel.findByIndex(
          0,
          new SheetDescriptor(TEST_SPREADHSEET_ID, 'Users'),
          DB_MODELS.COLUMNS
        );
