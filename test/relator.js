  ...
  TestRunner(function(){
    ...
    describe("relator", function(){
      it("PersistedModel.hasMany", function(){
        ...
        // 1 ------------------
        var f = db.feuilles[0], a = db.arbres[0];
      ...
      it("PersistedModel.hasManyCustom - scenario 1", function(){
        ...
        var tip = db.testintoparts[0], q = db.qraps[0];
        tip.linkToQrap(q);
        q.save();
      ...
      it("PersistedModel.belongsTo - scenario 2", function(){
        ...
        var f = new Feuille().save().instance, a = new Arbre().save().instance;
        f.linkToArbre(a);
        assert.equal(f.aid, a.id);
        f.save();
        var arbre = f.arbre();
      ...
      it("relation query caching - MANY TO ONE", function(){
        ...
        */
        ...
        var f = new Feuille().save().instance, a = new Arbre();
        f.linkToArbre(a);
        a.save();
