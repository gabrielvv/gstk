  ...
  TestRunner(function() {
    describe('Schema', function() {
      ...
      it('works', function() {
        ...
        assert.not.throw(
          mSchema.validate.bind(mSchema, { id: 'foo' }),
          assert.AnyError
        );
        assert.throw(
          mSchema.validate.bind(mSchema, { id: 123 }),
          assert.AnyError
        );
        assert.throw(mSchema.validate.bind(mSchema, {}), assert.AnyError);

        assert.not.throw(
          mSchema.validate.bind(mSchema, mSchema.generate()),
          assert.AnyError
        );
      });
      ...
      it('allows schema fusion', function() {
        ...
        assert.not.throw(
          mSchemaB.validate.bind(mSchemaB, { id: 'foo', n: 123 }),
          assert.AnyError
        );
        assert.throw(
          mSchemaB.validate.bind(mSchemaB, { id: 'foo' }),
          assert.AnyError
        ); // => missing n
        assert.throw(
          mSchemaB.validate.bind(mSchemaB, { n: 123 }),
          assert.AnyError
        ); // => missing id

        assert.not.throw(
          mSchemaB.validate.bind(mSchemaB, mSchemaB.generate()),
          assert.AnyError
        );
      });
      ...
      it('allows schema fusion with black list', function() {
        ...
        assert.not.throw(
          mSchemaB.validate.bind(mSchemaB, { TestId: 'foo', n: 123 }),
          assert.AnyError
        );
        assert.throw(
          mSchemaB.validate.bind(mSchemaB, { n: 123 }),
